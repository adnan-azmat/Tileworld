...
// import sun.font.TrueTypeFont; // riemer dont get 
...
// import tileworld.agent.NearestObjectAgent;
// import tileworld.agent.TWPositionReporterAgent;
import tileworld.agent.DRLTWAgent;
...
//    }
    ...
    public void start() {
        ...
        //The environment is also stepped each step
                ...
                // pos = this.generateRandomLocation();
                // createAgent(new TWPositionReporterAgent("agent3", pos.getX(), pos.getY(), this, Parameters.defaultFuelLevel));
                
                // pos = this.generateRandomLocation();
                // createAgent(new DRLTWAgent("agent4", pos.getX(), pos.getY(), this, Parameters.defaultFuelLevel));
                // pos = this.generateRandomLocation();
                // createAgent(new DRLTWAgent("agent5", pos.getX(), pos.getY(), this, Parameters.defaultFuelLevel));
                String parameterFilePath = "/home/riemer/Projects/AI6125-MAS/groupAssignment/agents/myworkspace/Tileworld/src/tileworld/Parameters2.java";
                pos = this.generateRandomLocation();
                createAgent(new DRLTWAgent("agent6", pos.getX(), pos.getY(), this, Parameters.defaultFuelLevel, parameterFilePath));
