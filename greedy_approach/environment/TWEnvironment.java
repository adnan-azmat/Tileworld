...
//    
    ...
    public void start() {
        ...
        int zoneIndentity = 0;
//        createAgent(new MyAgent(zoneIndentity, "agent 0", pos.getX(), pos.getY(), this, Parameters.defaultFuelLevel));
        createAgent(new MyInspectorAgent(zoneIndentity+2, "agentInspector 0", pos.getX(), pos.getY(), this, Parameters.defaultFuelLevel));
        // pos = this.generateRandomLocation();
        // createAgent(new MyInspectorAgent(zoneIndentity+2, "agentInspector 1", pos.getX(), pos.getY(), this, Parameters.defaultFuelLevel));
//        zoneIndentity = 0;
//        pos = this.generateRandomLocation();
...
//        createAgent(new MyAgent(index, "agentInspector1", pos.getX(), pos.getY(), this, Parameters.defaultFuelLevel));
        ...
        for (int i = zoneIndentity; i < Parameters.numAgent; i++) {
        	pos = this.generateRandomLocation();
        	assert(this.isInBounds(pos.getX(), pos.getY()));
            createAgent(new MyAgent(i, "agent "+i+1, pos.getX(), pos.getY(), this, Parameters.defaultFuelLevel));
        }
//        pos = this.generateRandomLocation();
