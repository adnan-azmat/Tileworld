 ...
 *
 */
public class TeamAgent4 extends TWAgent{
    private String name="agent4";
    ...
    public TeamAgent4(String name, int xpos, int ypos, TWEnvironment env, double fuelLevel) {
        ...
        if (!(curPath == null)  &&  this.rethinking==0 && ! "FuelStationFinding".equals(agentState1)){
            if ("PickingTile".equals(agentState1)){
                if (agentState2==1){
                    ...
                    if (pick_tile_chain.size()==0 && "agent4".equals(this.name)){
